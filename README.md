# VidaPlena - Landing Page

## Descripción del Proyecto

VidaPlena es una Landing Page desarrollada como parte de la evaluación EVA-5 de Programación Front-End.

El sitio presenta una empresa ficticia orientada al bienestar, salud integral y desarrollo personal, mostrando información sobre servicios, testimonios de clientes y un formulario de contacto.

---

## Objetivo

Desarrollar una Landing Page utilizando HTML5, CSS3, Git y GitHub, aplicando buenas prácticas de desarrollo web y estructura semántica.
...
**Objetivo:** Adaptar el sitio para dispositivos móviles y distintos tamaños de pantalla.
